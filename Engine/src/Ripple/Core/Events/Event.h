...
// 使用模板匹配 Ripple::Event 及其所有派生类
template <typename T>
struct fmt::formatter<T, std::enable_if_t<std::is_base_of<Ripple::Event, T>::value, char>>
	: fmt::formatter<std::string> {

	template <typename FormatContext>
	auto format(const Ripple::Event& e, FormatContext& ctx) const {
