...
namespace Ripple {
	...
	std::unordered_map<UUID, Scene*> s_ActiveScenes; // C#与引擎中元素之间的映射表
	...
	void OnScriptComponentConstruct(entt::registry& registry, entt::entity entity)
	{
		...
		RP_CORE_ASSERT(scene->m_EntityIDMap.find(entityID) != scene->m_EntityIDMap.end());
	...
	void Scene::OnRenderRuntime(Timestep ts)
	{
		...
		RP_CORE_ASSERT(cameraEntity, "Scene does not contain any cameras!");
...
// Render all sprites
	...
	Entity Scene::CreateEntityWithID(UUID uuid, const std::string& name, bool runtimeMap)
	{
		...
		RP_CORE_ASSERT(m_EntityIDMap.find(uuid) == m_EntityIDMap.end());
