...
namespace Ripple {
	...
	void Renderer::Init()
	{
		...
		Renderer::GetShaderLibrary()->Load("assets/shaders/RipplePBR_Static.glsl");
		Renderer::GetShaderLibrary()->Load("assets/shaders/RipplePBR_Anim.glsl");
	...
	{
		RP_CORE_ASSERT(renderPass, "Render pass cannot be null!");
	...
	{
		RP_CORE_ASSERT(s_Data.m_ActiveRenderPass, "No active render pass! Have you called Renderer::EndRenderPass twice?");
